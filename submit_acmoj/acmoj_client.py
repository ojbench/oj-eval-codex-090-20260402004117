...
class ACMOJClient:
    ...
    def submit_file(self, problem_id: int, filepath: str, language: str = "cpp") -> Optional[Dict]:
        try:
...
def main():
    ...
    # Raw file submission sub-command
    submit_file_parser = subparsers.add_parser("submit-file", help="Submit single source file contents")
